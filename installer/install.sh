...
DEFAULT_DEV_PY_ENV_PATH="/opt/FII-dev/${DEFAULT_DEV_PY_ENV_NAME}"
sudo -u "${USER}" bash -c \
...
# FII bootstrap from github
cd "${INSTALL_DIR}"
FII_GIT_URL="https://github.com/FirmwareCrunch/FII.git"
sudo -u "${USER}" bash -c "git clone '${FII_GIT_URL}'"
cd FII
